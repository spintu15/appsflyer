package com.example.sudhansubehera.appsflyerintegration_sudhansu;
...
import com.keshav.appsflyerTest.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppsFlyerLib.getInstance().startTracking(getApplication(), "3tgNcDr9W7ASdZJZtxncFR");
        ...
        AppsFlyerLib.getInstance().registerConversionListener(this, new AppsFlyerConversionListener() {
            ...
            public void onInstallConversionDataLoaded(Map<String, String> conversionData) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ((TextView) findViewById(R.id.textView)).setText(install_type + "\n" + install_message);
                    }
                });
            }
